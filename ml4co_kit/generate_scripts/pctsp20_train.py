...
for seed in tqdm(range(16)):
    ...
    input_file = f"/mnt/nas-new/home/panwenzheng/chennuoyan/CORectifier/attention-learn-to-route/data/pctsp/pctsp20_train_seed{seed}.pkl"
    output_file = os.path.join(output_dir, f"pctsp20_train_seed{seed}.txt")

    solver.from_pickle(input_file)
...
final_output_file = os.path.join(output_dir, "pctsp20_train.txt")

with open(final_output_file, 'w') as outfile:
    for seed in range(16):
        seed_file_path = os.path.join(output_dir, f"pctsp20_train_seed{seed}.txt")
