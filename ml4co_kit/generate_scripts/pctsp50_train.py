...
for seed in tqdm(range(16)):
    ...
    input_file = f"/mnt/nas-new/home/panwenzheng/chennuoyan/CORectifier/attention-learn-to-route/data/pctsp/pctsp50_train_seed{seed}.pkl"
    output_file = os.path.join(output_dir, f"pctsp50_train_seed{seed}.txt")
...
final_output_file = os.path.join(output_dir, "pctsp50_train.txt")

with open(final_output_file, 'w') as outfile:
    for seed in range(16):
        seed_file_path = os.path.join(output_dir, f"pctsp50_train_seed{seed}.txt")
